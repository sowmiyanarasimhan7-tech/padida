import { $ as setRangeValue, A as isArray, B as rectBounce, C as deepExtend, D as getLogger, E as executeOnSingleOrMultiple, F as isPointInside, G as getDistance, H as calcPositionOrRandomFromSize, I as isSsr, J as getRandom, K as getDistances, L as itemFromArray, M as isInArray, N as isNumber, O as getSize, P as isObject, Q as randomInRange, R as itemFromSingleOrMultiple, S as circleBounceDataFromParticle, T as divModeExecute, U as calcPositionOrRandomFromSizeRanged, V as addEasing, W as clamp, X as getRangeValue, Y as getRangeMax, Z as getValue, _ as rangeColorToRgb, a as ValueWithRandom, b as calculateBounds, c as drawLine, d as getHslAnimationFromHsl, et as Vector, f as getLinkColor, g as rangeColorToHsl, h as getStyleFromRgb, i as loadParticlesOptions, j as isDivModeEnabled, k as initParticleNumericAnimationValue, l as drawTriangle, m as getStyleFromHsl, n as Circle, o as AnimatableColor, p as getLinkRandomColor, q as getEasing, r as Rectangle, rt as mouseMoveEvent, s as OptionsColor, t as tsParticles, tt as errorPrefix, u as colorMix, v as rgbToHsl, w as divMode, x as circleBounce, y as arrayRandomIndex, z as loadFont } from "./esm-CpAEpTLl.js";
...
var EmitterInstance = class {
	constructor(engine, emitters, container, options, position) {
		...
		this._emitParticles = (quantity) => {
			...
			for (let i = 0; i < quantity; i++) {
				...
				if (this.spawnColor) {
					...
					if (!particlesOptions.color) particlesOptions.color = { value: this.spawnColor };
		...
		this._setColorAnimation = (animation, initValue, maxValue) => {
			...
			const colorOffset = randomInRange(animation.offset), emitFactor = 1e3 * getRangeValue(this.options.rate.delay) / container.retina.reduceFactor;
			return (initValue + getRangeValue(animation.speed ?? 0) * container.fpsLimit / emitFactor + colorOffset * 3.6) % maxValue;
		};
		this._engine = engine;
